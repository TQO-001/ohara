    ...
    <div className="w-full max-w-sm relative z-10">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400 text-sm">
          New here?{' '}
          <Link href="/register" className="text-purple-400 hover:text-purple-300 font-medium transition-colors hover:drop-shadow-[0_0_8px_rgba(168,85,247,0.4)]">
            Create an account
          </Link>
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center px-1">
            ...
            <Link 
              ...
              className="text-purple-400 text-xs font-medium hover:text-purple-300 transition-all"
            >      
              Forgot?
            </Link>
          </div>
        ...
        <div className="pt-2 space-y-6">
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-purple-600 hover:bg-purple-500 disabled:opacity-50 text-white font-medium py-3 px-4 rounded-xl transition-all shadow-lg shadow-purple-900/20 active:scale-[0.98] hover:shadow-[0_0_25px_rgba(168,85,247,0.4)]"
          >
